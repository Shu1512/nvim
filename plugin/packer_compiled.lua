...
_G.packer_plugins = {
  ale = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/shu1512/.local/share/nvim/site/pack/packer/opt/ale",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-abolish', 'nvim-colorizer.lua', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
